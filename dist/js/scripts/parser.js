 ...
 * */
export function findRepostHeader(parent) {
    return parent.querySelector('div[data-testid*="feedItem"] a[href^="/profile/"] > svg + div > div > div');
}
/**
 * Returns all posts found in parent
 */
export function findAllPosts(parent) {
    return parent.querySelectorAll('div[data-testid*="feedItem"]');
}
export function findPostsAndReposts(node) {
...
export function findFeedContainerByIndex(index) {
